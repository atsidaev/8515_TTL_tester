void test_C4520(void)
    {   
        ...
        Port_H=(BIT_H6 | BIT_H0);
        delay_ms(1);
        if ((Pin_L==(BIT_L1 | BIT_L2)) && (Pin_H==(BIT_H6 | BIT_H5 | BIT_H0)) && (res==1)) res=1;
            else res=0;           
        Port_L=(BIT_L1);
        Port_H=(BIT_H6 | BIT_H0);
        Port_L=(BIT_L0 | BIT_L1);
        ...
        Port_H=(BIT_H6 | BIT_H0);
        delay_ms(1);
        if ((Pin_L==(BIT_L1 | BIT_L3)) && (Pin_H==(BIT_H6 | BIT_H4 | BIT_H0)) && (res==1)) res=1;
            else res=0;
        for (i=0;i<10;i++){    
        Port_L=(BIT_L1);
        Port_H=(BIT_H6 | BIT_H0);
        ...
        Port_H=(BIT_H0); }
        delay_ms(1);
        if ((Pin_L==(BIT_L4 | BIT_L5)) && (Pin_H==(BIT_H3 | BIT_H2 | BIT_H0)) && (res==1)) res=1;
            else res=0;                  
        if (res==1) sym[0]=10;
            else sym[0]=11; 
        Port_L=0;
